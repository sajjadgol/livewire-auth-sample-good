...
class Create extends Component
{
    ...
    protected $rules=[
        ...
        'end_date' => 'nullable|date_format:Y-m-d H:i|after_or_equal:start_date|required_if:never_expired,false', 
    ...
    public function store() {
        ...
        return redirect(route('promotion-management'))->with('status',__('Promotions.Promotion successfully created.'));
    }
