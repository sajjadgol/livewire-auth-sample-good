...
class Edit extends Component
{
    ...
    protected $rules=[
        ...
        'promotion.end_date' => 'nullable|after_or_equal:start_date|required_if:never_expired,false', 
    ...
    public function edit() {
        ...
        return redirect(route('promotion-management'))->with('status',__('Promotions.Promotion successfully updated'));
    }
