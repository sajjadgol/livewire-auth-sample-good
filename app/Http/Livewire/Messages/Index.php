...
{   
    ...
    {   
        ...
        return view('livewire.messages.index',[
            'messages' =>$this->loadData ? $message->searchMultipleMessage(trim(strtolower($this->search)))->orderBy($this->sortField, $this->sortDirection)->paginate($this->perPage) : [],
        ]);
    }
    ...
    public function destroyConversationConfirm($order_id, $role)
    {
        ...
        $this->dispatchBrowserEvent('swal:confirm', [
                ...
                'message' => __('messages.Are you sure'), 
                'text' => __('messages.If deleted you will not be able to recover this Conversation')
            ]);
    }
    ...
    public function remove()
    {
        ...
        $this->dispatchBrowserEvent('alert', 
            ['type' => 'success',  'message' => __('messages.Conversation Delete Successfully')]);
    }
