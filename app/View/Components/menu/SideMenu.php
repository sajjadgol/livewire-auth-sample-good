...
class SideMenu extends Component
{
    ...
    {
        $this->data = \Storage::disk('local')->exists('menus/sidebar.json') ? json_decode(\Storage::disk('local')->get('menus/sidebar.json')) : [];
        $this->data = collect($this->data)->map(function ($val,$key)
        {
            if($val->type == 'divider'){
                return $val;
            }
