    ...
    {    
        OrderStatusHistory::create(
            [
                ...
                'title' => __('order/customer_message_status.:type status has been changed :old_status to :new_status :txn_id',['type' => "Order",'old_status' => ucfirst(str_replace('_', ' ', $this->order_status)),'new_status' => ucfirst(str_replace('_', ' ',$new_status)),'txn_id'=> null]),
            ]
        );
    ...
    public function CreateHistory()
    {
        OrderStatusHistory::create(
            [
                ...
                'title'   => __('order/customer_message_status.:type status has been changed :old_status to :new_status (:txn_id)',['type' => "Order",'old_status' => ucfirst(str_replace('_', ' ', $this->order_status)),'new_status' =>ucfirst(str_replace('_', ' ', $this->order_status)),'txn_id'=>null]),
            ]
            );
        return $this;
    }
