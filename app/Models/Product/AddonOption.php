...
class AddonOption extends Model implements TranslatableContract
{
     ...
     */
    public $translatedAttributes = ['name', 'small_descriptions'];
    ...
    {
        return $this->belongsTo(Store::class, 'store_id', 'id')->withTranslation();
    }
}
