...
class Product extends Model implements TranslatableContract
{
 ...
 /**
     ...
     */
    public $translatedAttributes = ['name','descriptions'];
    ...
    {
        return $this->belongsTo(ProductCategories::class, 'categories_ids', 'id')->withTranslation();
    }
    /**
    ...
    {
        return $this->hasOne(Store::class,'id','store_id')->withTranslation();
    }
