    ...
    <div class="sidenav-header">
        <i class="fas fa-times p-3 cursor-pointer text-white opacity-5 position-absolute end-0 top-0 d-none d-xl-none"
            ...
            <a class="navbar-brand m-0 p-4 d-flex align-items-center text-wrap" href="{{ route('dashboard') }}">
                ...
                @endif
                <span class="ms-2 font-weight-bold text-white h5 ">
                     ...
                     @can('product-management', 'product-category-management', 'product-tag-management', 'product-addon-management','store-promotion')
                        ...
                        <li class="nav-item ">
                            ...
                            <div class="collapse {{ strpos(Request::route()->uri(), 'orders')=== false ? '' : 'show' }} "
                                ...
                                <ul class="nav nav-sm flex-column ms-2">
                                    <li class="nav-item">
                                        <a class="nav-link text-white {{ (Route::currentRouteName() == 'order-management' && REQUEST::input('orderStatus') == '') ? 'active' : '' }}"
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <a class="nav-link text-white {{ (Route::currentRouteName() == 'order-management' && REQUEST::input('orderStatus') == 'pending') ? 'active' : '' }}"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-white {{ (Route::currentRouteName() == 'order-management' && REQUEST::input('orderStatus') == 'completed') ? 'active' : '' }}"
