                        ...
                        <div class="row ">
                            <div class="col-12  mb-4">
                                <div class="input-group input-group-static">
                                    <label>Name *</label>
                                    <input wire:model.lazy="product.name" type="text" class="form-control" placeholder="Enter a Name">
                                </div>
                                @error('product.name')
                                ...
                                <div class="input-group input-group-static">
                                    ...
                                    <div wire:ignore class="h-100 m-2 me-1 ms-auto w-100">
                                        <div x-data x-ref="quill" x-init="quill = new Quill($refs.quill, {theme: 'snow'});
                                            ...
                                            x-on:quill-text-change.debounce.200ms="@this.set('product.descriptions', $event.detail)">
