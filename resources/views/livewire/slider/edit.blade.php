        ...
        <div class="col-lg-9 col-12 mx-auto position-relative">
                                ...
                                <div class="row mt-6">
                                    <div class="col-12 col-sm-6">
                                        ...
                                        dateFormat: 'Y-m-d H:i'});">
                                            ...
                                            <input wire:model.lazy="slider.start_date_time" id="from_date" x-ref="picker" class="form-control" type="text" placeholder="Enter a Start Date Time" />
                                        </div>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        ...
                                        dateFormat: 'Y-m-d H:i'});">
                                                ...
                                                <input wire:model.lazy="slider.end_date_time" id="to_date"  x-ref="picker" class="form-control" type="text" placeholder="Enter a End Date Time" />
                                        </div>
                                ...
                                <div class="row  mt-4">
                                    <div class="col-md-12">
                                        ...
                                        <button wire:loading.attr="disabled" type="submit" name="submit"  class="btn bg-gradient-dark m-0 ms-2">
                                            <span wire:loading.remove wire:target="edit"> Update Slider</span>
            ...
            <div class="card mt-4" id="basic-info">
                ...
                <div class="card-body px-0 pb-0">
                    <div class="d-flex justify-content-end me-3 mt-sm-n6"><button wire:click ="resetInputFields"  type="button" class="btn bg-gradient-dark" data-bs-toggle="modal" data-bs-target="#exampleModal">ADD</button></div>
                </div>
                @if (session('status'))
                <div class="row">
                    <div class="col-sm-12">
                ...
                <div  class="modal-content">
                    ...
                    <div class="modal-body ms-6">
                        ...
                        <div class="modal-footer mt-2">
                            ...
                            <button wire:loading.attr="disabled" type="button"  wire:click.prevent='storeImage()' id="storeImage" class="btn bg-gradient-dark" data-dismiss="modal">
                                <span wire:loading.remove wire:target="storeImage"> Save Changes</span>
                                        <span wire:loading wire:target="storeImage"><x-buttonSpinner></x-buttonSpinner></span>
                                </button>
                            </div>
                        </div>
                    </div>  
