                        ...
                        <div class="row mt-6">
                            <div class="col-12 col-sm-6">
                                ...
                                dateFormat: 'Y-m-d H:i'});">
                                    ...
                                    <input wire:model.lazy="start_date_time" id="from_date" x-ref="picker" class="form-control" type="text" placeholder="Enter a Start Date Time" />
                                </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="input-group input-group-static " wire:ignore x-data x-init="flatpickr($refs.picker, {allowInput: false,enableTime: 'true',
                                    dateFormat: 'Y-m-d H:i'});">
                                        ...
                                        <input wire:model.lazy="end_date_time" id="to_date"  x-ref="picker" class="form-control flatpickr" type="text"  placeholder="Enter a End Date Time" />
                                </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                ...
                                <button wire:loading.attr="disabled" type="submit" name="submit" class="btn bg-gradient-dark m-0 ms-2">
                                    <span wire:loading.remove wire:target="store"> Create Slider</span>
